...
## Technology
HTML5, CSS3, Bootstrap (v3.3.6) AngularJS (v1.4.9) were used on the front end, interacting with back end technologies Node.js (v5.3.0), Express (v4.13.4), Mongoose (v4.3.7), and MongoDB (v3.2.0). Authentication utilizes Passport (v0.3.2) and bcrypt (v0.8.5).
